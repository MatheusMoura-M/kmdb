...
<p>Nesse projeto foi adequado um sistema usando Generic Views, Model Serializer e Postgres, além de gerenciar um sistema de cadastro de filmes, gêneros e reviews.</p>
...
```python
pytest --testdox -vvs tests/movies/
```

- Rodando testes de songs:
```python
pytest --testdox -vvs tests/reviews/
```
